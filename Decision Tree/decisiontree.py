...
f.close();
print("With training date, the prediction error is", error_counter/number_counter)
'''
'''
#test training data
number_counter=0
error_counter=0
with open ( r"Mytest.csv" , 'r' ) as f :
    tar=1
    for line in f :
        if tar==1 :
            tar=tar+1
